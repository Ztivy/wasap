...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  sendCodeToPhone(){
    ...
    if(phoneNumber.isEmpty){
      ...
      return showAlertDialog(context: context, message: "The phone number you entered is too short for the country: $countryName.\n\nInclude your area if you haven't");
    }
    else if(phoneNumber.length >10){
      return showAlertDialog(context: context, message: 'The phone number you entered is too long for the country: $countryName',
      );
    }
      ...
      showCountryPicker(
        ...
        countryListTheme: CountryListThemeData(
          ...
          inputDecoration: InputDecoration(
            ...
            prefix: const Icon(Icons.language,color:Coloors.greenDark,),
  ...
  @override
  void initState() {
    countryNameController=TextEditingController(text: 'Mexico');
    countryCodeController=TextEditingController(text: '52');
