...
import 'package:wasap2/common/widgets/short_h_bar.dart';
        ...
        return Column(
          ...
          children: [
            ...
            Row(
              children: [
                SizedBox(width: 20,),
                imagePickerIcon(onTap: (){}, icon: Icons.camera_alt_rounded, text: 'Camera'),
                SizedBox(width: 15,),
                imagePickerIcon(onTap: (){
                   Navigator.pop(context);
                  Navigator.of(context).push(
                    MaterialPageRoute(builder: (context)=>ImagePickerPage(),),
                  );
                }, icon: Icons.photo_camera_back_rounded, text: 'Gallery'),
              ],
            ),
            SizedBox(height: 15,),
          ],
      ...
      return Column(
        children: [
          CustomIconButton(
            ...
            minWidth: 50,
            border: Border.all(color: context.theme.greyColor!.withOpacity(.2),
            width: 1,
            ),
          ),
          SizedBox(height: 5,),
