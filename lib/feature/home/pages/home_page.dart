...
import 'package:wasap2/feature/home/pages/call_home_page.dart';
import 'package:wasap2/feature/home/pages/chat_home_page.dart';
import 'package:wasap2/feature/home/pages/status_home_page.dart';
...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(length: 3,
      child: Scaffold(
        appBar: AppBar(
          title: Text('WhatsApp', style: TextStyle(letterSpacing: 1),),
          elevation: 1,
          actions: [
