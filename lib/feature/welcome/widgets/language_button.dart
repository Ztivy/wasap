            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Text('App Language',style:TextStyle(
                    fontSize: 20,
              ...
              thickness: .5,),
              RadioListTile(value: true,groupValue: true, onChanged: (value){},activeColor: Coloors.greenDark,title: const Text('English'),
              subtitle: Text("phone's language",style: TextStyle(
                color: context.theme.greyColor,
              )),),
              RadioListTile(value: true,groupValue: false, onChanged: (value){},activeColor: Coloors.greenDark,title: const Text('Español'),
              subtitle: Text("Español",style: TextStyle(
                color: context.theme.greyColor,
              )),)
            ],
          ),
