...
import 'package:wasap2/feature/welcome/widgets/language_button.dart';
import 'package:wasap2/feature/welcome/widgets/privacy_and_terms.dart';
      ...
      body: Column(
        children: [
          ...
          Expanded(child: Column(
            children: [
              const Text('Welcome to wasap',style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold,),),
